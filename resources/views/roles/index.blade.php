<x-layouts.app>
    ...
    <x-search-header backRoute="roles.index" resourceName="roles" />
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4">
        ...
        <!-- Search Field -->
        <form method="GET" action="{{ route('roles.index') }}" class="w-full sm:w-1/3">
            @csrf
            <div class="relative">
        ...
        <table class="min-w-full text-sm text-left text-gray-700">
            <thead class="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-200 uppercase text-xs">
                <tr>
                    ...
                    <th class="px-6 py-3">Number of related users</th>
            ...
            <tbody>
                ...
                <tr class="border-t hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="px-6 py-4 font-medium dark:text-gray-200">{{ $role->name }}</td>
                    <td class="px-6 py-4 font-medium dark:text-gray-200">{{ $role->users->count() }}</td>
                ...
                @empty
                <tr class="border-t">
                    <td class="px-6 py-4 font-medium dark:text-gray-200">There are no roles yet.</td>
                </tr>
                @endforelse
