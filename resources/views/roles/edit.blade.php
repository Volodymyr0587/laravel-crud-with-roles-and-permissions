<x-layouts.app>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Edit role <span class="font-bold">{{ $role->name }}</span></p>
    </div>

    <form class="max-w-sm mx-auto" action="{{ route('roles.update', $role) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-5">
