<x-layouts.app>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Edit product <span class="font-bold">{{ $product->name
                }}</span></p>
    </div>

    <form class="max-w-2xl mx-auto" action="{{ route('products.update', $product) }}" method="POST">
        @csrf
        @method('PATCH')
